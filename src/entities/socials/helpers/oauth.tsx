...
import { ISocialConfig } from "@/entities/socials/model"


const getDiscordUrl = (config: ISocialConfig) => {
...
const getXUrl = (config: ISocialConfig) => {
...
const getGithubUrl = (config: ISocialConfig) => {
