...
import { useTasksPlatform, useTasksSettings } from "@/entities/tasks/api"
import ModalReferralCode from "@/entities/referral_program/ui/ModalReferralCode"
...
export default function CardUserReferralCode() {
    ...
    const {data: dataTasks} = useTasksPlatform()
    const {data: dataTasksSettings} = useTasksSettings()
                        ...
                        >
                            {
                                !data?.referrer &&
                                    <Text as="p">
                                        Enter referral code - <Text className={css.points}>{dataTasks?.filter(task => task.name === 'task_referrer')[0].reward} points</Text>
                                    </Text>
                            }
                            <Text as="p">
                                Referrer interest - <Text className={css.points}>{dataTasksSettings?.referral_interest}% of points</Text>
                            </Text>
                            <Image
